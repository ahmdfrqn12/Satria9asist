...
cl = LineClient()
#cl = LineClient(authToken='EHLxG9qmVJ1dgXwJ7KG0.fGIUiExEjuE1/OChSHYIia.u2wsvUIox8NpNc1kqncI1xFvnvTmcVOTK631zNTVALU=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))
print ("AKUN BOTTROX BOTS 1")
ki = LineClient()
#ki = LineClient(authToken='EHCUotvV7tOQrrepZ6M2.o8LSrfCelHJhhggYpY3ECG.G7bSEsB9FOvdUS2oTEAG1sQzH9OqMhPji0Q8ld6dRaI=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))
print ("AKUN BOTTROX BOTS 2")
kk = LineClient()
#kk = LineClient(authToken='EHhNoL7qKTWbJOgGNXUb.7CWBt2PgZYSjdrZ86mcd2W.vWkV+4gs3Y9vXwwH7l5ejN0vOaETYGX7ZcBqk+neSBs=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))
print ("AKUN BOTTROX BOTS 3")
kc = LineClient()
#kc = LineClient(authToken='EHhNoL7qKTWbJOgGNXUb.7CWBt2PgZYSjdrZ86mcd2W.vWkV+4gs3Y9vXwwH7l5ejN0vOaETYGX7ZcBqk+neSBs=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))
print ("AKUN BOTTROX BOTS 4")
kb = LineClient()
#kb = LineClient(authToken='EHhNoL7qKTWbJOgGNXUb.7CWBt2PgZYSjdrZ86mcd2W.vWkV+4gs3Y9vXwwH7l5ejN0vOaETYGX7ZcBqk+neSBs=')
kb.log("Auth Token : " + str(kb.authToken))
channel4 = LineChannel(kb)
kb.log("Channel Access Token : " + str(channel4.channelAccessToken))
print ("AKUN BOTTROX BOTS 5")
kd = LineClient()
#kd = LineClient(authToken='EHhNoL7qKTWbJOgGNXUb.7CWBt2PgZYSjdrZ86mcd2W.vWkV+4gs3Y9vXwwH7l5ejN0vOaETYGX7ZcBqk+neSBs=')
kd.log("Auth Token : " + str(kd.authToken))
channel5 = LineChannel(kd)
kd.log("Channel Access Token : " + str(channel5.channelAccessToken))
print ("AKUN BOTTROX BOTS 6")
ke = LineClient()
#ke = LineClient(authToken='EHhTiawkohNIofv7McJ7.Dtx5QP5akDmJxV1TeZaq9W.tIe5BFvJKr5YdcRtsbw8FGT/bFZ8oV9n66rCLWPi6TY=')
ke.log("Auth Token : " + str(ke.authToken))
channel6 = LineChannel(ke)
ke.log("Channel Access Token : " + str(channel6.channelAccessToken))
print ("AKUN BOTTROX BOTS 7")
kf = LineClient()
#kf = LineClient(authToken='EHhTiawkohNIofv7McJ7.Dtx5QP5akDmJxV1TeZaq9W.tIe5BFvJKr5YdcRtsbw8FGT/bFZ8oV9n66rCLWPi6TY=')
...
kg = LineClient()
#kg = LineClient(authToken='EHhTiawkohNIofv7McJ7.Dtx5QP5akDmJxV1TeZaq9W.tIe5BFvJKr5YdcRtsbw8FGT/bFZ8oV9n66rCLWPi6TY=')
...
kh = LineClient()
#kh = LineClient(authToken='EHhTiawkohNIofv7McJ7.Dtx5QP5akDmJxV1TeZaq9W.tIe5BFvJKr5YdcRtsbw8FGT/bFZ8oV9n66rCLWPi6TY=')
kh.log("Auth Token : " + str(kh.authToken))
channel9 = LineChannel(kh)
kh.log("Channel Access Token : " + str(channel9.channelAccessToken))
print ("AKUN GHOTS 1")
satria = LineClient()
#satria = LineClient(authToken='EHCUotvV7tOQrrepZ6M2.o8LSrfCelHJhhggYpY3ECG.G7bSEsB9FOvdUS2oTEAG1sQzH9OqMhPji0Q8ld6dRaI=')
...
sw = LineClient()
#sw = LineClient(authToken='EHCUotvV7tOQrrepZ6M2.o8LSrfCelHJhhggYpY3ECG.G7bSEsB9FOvdUS2oTEAG1sQzH9OqMhPji0Q8ld6dRaI=')
                        ...
                        if cmd == "unsend off":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                zx2.append(zx)
                                zxc += pesan2
                                text = xpesan + zxc + ret_ + "┝────────────────\n│♠ ᴄʟᴏᴄᴋ: 「"+ datetime.strftime(timeNow,'%H:%M:%S')+"」 "+"\n│♠ A.D TEAM ᴅᴀᴛᴇ: 「"+ datetime.strftime(timeNow,'%Y-%m-%d') +"」\n╰────A.D TEAMஜ─────╯"
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               sendMention(msg.to, sender, "「 ⊰์◉⊱A.D TEAM⊰์◉⊱ 」\n")
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                               ...
                               ki.sendMessage(msg.to, "p")
                        elif text.lower() == 'assalamualaikum':
                               ki.sendMessage(msg.to, "ُp")
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                timeCreated = []
                                timeCreated.append(time.strftime("%d-%m-%Y [ %H:%M:%S ]", time.localtime(int(G.createdTime) / 1000)))
                                ret_ += "❧⊰์◉⊱A.D TEAM⊰์◉⊱ Fams Grup Info\n"
                                ret_ += "\n❧Nama Group : {}".format(G.name)
                                ret_ += "\n❧ID Group : {}".format(G.id)
                          ...
                          try:                          	
                              for mentionMembers in range(Dmem+1):
                                  ...
                                  for dataMention in group.members[mentionMembers*20 : (mentionMembers+1)*20]:
                                      ...
                                      no += 1
                                      ret_ += "\n╠[{}] @!".format(str(no))
                                  ret_ += "\n╚══════════════\n╔═══════════════\n.  TOTAL MEMBER [ {} ]\n╚═══════════════\n.        ⊰์◉⊱A.D TEAM⊰์◉⊱\n╰══ CREATOR: A.D TEAM \nhttps://line.me/ti/p/~ahmdfrqn_".format(str(len(dataMid))) 
                         ...
                         if msg._from in creator:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.cancelGroupInvitation(op.param1,[Zmid])
...
#===========COMMAND BLACKLIST============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in creator:
                              ...
                              ki.sendMessage(msg.to,"sudah tidak ada blacklist " +mc)
#===========COMMAND SET============#
